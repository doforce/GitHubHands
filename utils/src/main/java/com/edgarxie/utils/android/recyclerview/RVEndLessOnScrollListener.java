...
public abstract class RVEndLessOnScrollListener extends RecyclerView.OnScrollListener{
    ...
    public RVEndLessOnScrollListener(LinearLayoutManager linearLayoutManager) {
